export function drawCow(ctx, x, y) {
    // Kopf
...
export function drawChicken(ctx, x, y) {
    // Körper
...
export function drawDog(ctx, x, y) {
    // Kopf
...
export function drawHorse(ctx, x, y) {
    // Kopf
...
export function drawPig(ctx, x, y) {
    // Kopf
...
export function drawDonkey(ctx, x, y) {
    // Ohren
