...
function drawCurves() {
    for (let i = 0; i < 5; i++) {
        ...
        crc2.bezierCurveTo(random(0, canvas.width), random(0, canvas.height), random(0, canvas.width), random(0, canvas.height), random(0, canvas.width), random(0, canvas.height));
        crc2.strokeStyle = randomColor();
